...
import { Sparkles, Zap, KeyRound, History, Info } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ onChangeApiKey, onToggleHistory, onOpenProjectInfo }) => {
  return (
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        {onOpenProjectInfo && (
          ...
          >
            ...
            <span className="hidden md:block">About & Donate</span>
          </button>
        )}
